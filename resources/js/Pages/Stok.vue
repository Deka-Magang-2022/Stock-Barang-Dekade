...
<template>
  ...
  <div class="flex flex-row">
    <Sidebar />
    <div class="bg-gray-300 w-full h-full min-h-screen p-9">
      <div class="border-b-2 border-b-black pb-6">
        <p class="text-6xl text-gray-900 capitalize">Stok barang</p>
      </div>
      <div class="mt-6 text-left">
        <p class="uppercase text-left">Barang yang berada di stok</p>
        <table class="w-full">
          <thead>
          ...
          <tbody>
            <tr class="grid grid-cols-7">
              ...
              <td class="capitalize overflow-auto">8/11/22</td>
