...
<template>
  <!--  header -->
  <div class="w-full flex flex-row px-10 bg-gray-300 text-gray-900">
  ...
  <!-- sidenav  -->
  <div class="bg-gray-200 text-gray-900 w-56 font-[Helvetica] fixed">
    <section class="overflow-auto">
      <section class="hover:text-blue-300 hover:bg-blue-900 overflow-hidden">
      ...
      <section class="hover:text-blue-300 hover:bg-blue-900">
        <JetNavLink class="flex flex-row items-center pl-3 py-2" href="/transaksi">
          <span>
            <svg
              class="w-8 h-8 pr-2"
              xmlns="http://www.w3.org/2000/svg"
      ...
      <section class="hover:text-blue-300 hover:bg-blue-900">
        <JetNavLink class="flex flex-row items-center pl-3 py-2" href="/barangmasuk">
          <span>
            <svg
              class="w-8 h-8 pr-2"
              xmlns="http://www.w3.org/2000/svg"
      ...
      <section class="hover:text-blue-300 hover:bg-blue-900">
        <Dropdown>
          <template #trigger>
            <div class="flex flex-row items-center pl-3 py-2 cursor-pointer">
              <span>
                <svg
                  class="w-8 h-8 pr-2"
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <template #content>
            <div class="flex flex-col">
              <DropdownLink href="/akun" class="pl-10 py-2 hover:text-blue-900 text-white"
                >Akun
              </DropdownLink>
              <DropdownLink
                href="/password"
                class="pl-10 py-2 hover:text-blue-900 text-white"
              >
                Password
              </DropdownLink>
            </div>
  ...
  <!-- the content -->
  <section class="xl:pl-60 lg:pl-60 px-10">
    <slot />
  </section>
  <!--  -->
  ...
  <!-- SykIL -->
  <footer>
    <div class="flex px-10 py-1 bg-slate-300">
