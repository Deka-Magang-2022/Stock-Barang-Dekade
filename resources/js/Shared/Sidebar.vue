...
<template>
  <div
    class="h-auto min-h-screen bg-[image:linear-gradient(to_top,theme(colors.blue.900)_90%,theme(colors.blue.500))] text-gray-100 w-56 font-[Helvetica]"
  >
    <section class="pt-5 pb-5">
      <section class="">
        <JetNavLink
          class="flex flex-row items-center pl-3 py-2 hover:bg-gray-500"
          href="/dashboard"
        >
          <span>
            <svg
