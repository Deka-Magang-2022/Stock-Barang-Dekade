...
<div class="border-b-2 border-b-black pb-6">
    <p class="text-xl sm:text-6xl text-gray-900">Dashboard</p>
</div>
<div class="flex flex-col space-y-5 space-x-0 lg:space-y-0 lg:space-x-5 lg:flex-row pt-6 [&>*]:p-6 hover:[&>*]:shadow-xl [&>*]:bg-white">
    <div class="flex-1 rounded-lg transition-all duration-300">
