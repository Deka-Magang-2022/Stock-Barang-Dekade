            ...
            <section class="pt-5 pb-5">
                <section>
                    <a class="flex flex-row items-center pl-3 py-2 hover:bg-gray-500" href="/dashboard">
                        <span>
                            <svg class="w-8 h-8 pr-2" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img"
                ...
                <section>
                    <a class="flex flex-row items-center pl-3 py-2 hover:bg-gray-500" href="/barang-keluar">
                        <span>
                            <svg class="w-8 h-8 pr-2" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
