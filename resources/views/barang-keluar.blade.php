...
<title>Barang Keluar</title>
    <div class="border-b-2 border-b-black pb-6">
        <p class="text-xl sm:text-6xl text-gray-900 capitalize">Barang Keluar</p>
    </div>
    ...
    <x-tabel>
        <x-slot name="tpala">
            ...
            <td class="border-r">total barang keluar</td>
            <td class="border-r">satuan</td>
            <td class="border-r">aksi</td>
        </x-slot>
        <x-slot name="tbadan">
