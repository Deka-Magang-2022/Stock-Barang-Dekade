            ...
            <table class="w-full">
                <thead>
                    <tr class="font-bold border-b">
                        ...
                        <td class="capitalize p-4 border-r">jumlah</td>
                ...
                <tbody>
                    <tr class="hover:bg-gray-200">
                        ...
                        <td class="capitalize p-4 overflow-auto border-r">4 kaleng</td>
                        <td class="capitalize p-4 overflow-auto border-r">selasa/7/2022</td>
