...
<div class="border-b-2 border-b-black pb-6">
    <p class="text-xl sm:text-6xl text-gray-900 capitalize">Stok barang</p>
</div>
<x-tabel>
    <x-slot name="tpala">
        <td class="border-r">no</td>
        <td class="border-r">nama barang</td>
        <td class="border-r">stok sebelumnya</td>
        <td class="border-r">h/b/t</td>
        <td class="border-r">stok sekarang</td>
        <td class="">aksi</td>
    </x-slot>
    ...
    <x-slot name="tbadan">
        ...
        <td class="border-r">1 kaleng</td>
        <td class="border-r">8/10/22</td>
        <td class="border-r">5 kaleng</td>
        <td class="">
